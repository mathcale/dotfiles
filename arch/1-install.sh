...
packagesPacman=("amd-ucode" "base" "base-devel" "bat" "bind" "bleachbit" "blueman" "bluez-hid2hci" "bluez-utils" "btop" "btrfs-progs" "cliphist" "cmatrix" "corectrl" "cups" "cups-pdf" "dnsmasq" "docker" "docker-compose" "dunst" "efibootmgr" "eog" "eza" "fastfetch" "feh" "ffmpeg4.4" "figlet" "file-roller" "firefox" "flatpak" "font-manager" "freerdp" "gamescope" "gimp" "git" "git-delta" "gnome-calculator" "gnome-keyring" "gnome-system-monitor" "gnome-themes-extra" "gparted" "grim" "grub" "grub-customizer" "gvfs" "gvfs-nfs" "gvfs-smb" "htop" "imagemagick" "inkscape" "iotop" "kitty" "kubectl" "kvantum" "lazygit" "libguestfs" "linux" "linux-firmware" "lutris" "man-db" "mangohud" "mpc" "mpd" "mpv" "nano" "ncmpcpp" "neovim" "networkmanager" "nm-connection-editor" "noto-fonts-emoji" "nwg-look" "obs-studio" "os-prober" "otf-font-awesome" "otf-monaspace" "pacman-contrib" "pavucontrol" "pipewire-alsa" "pipewire-pulse" "polkit-gnome" "powertop" "protobuf" "python-click" "python-pip" "python-psutil" "python-rich" "python-pyusb" "qbittorrent" "qemu-full" "qt5ct" "radeontop" "ripgrep" "rlwrap" "rofi" "samba" "slurp" "speedtest-cli" "spice-vdagent" "starship" "steam" "swappy" "system-config-printer" "thefuck" "thunar" "thunar-archive-plugin" "thunderbird" "traceroute" "ttf-fira-code" "ttf-fira-sans" "ttf-firacode-nerd" "ttf-joypixels" "ttf-overpass" "tumbler" "unrar" "virt-manager" "virt-viewer" "waybar" "wget" "whois" "xdg-desktop-portal-gnome" "xdg-desktop-portal-gtk" "xfce4-power-manager" "xorg-xhost" "xsensors" "yarn" "zsh" "zip");

packagesYay=("1password" "adw-gtk-theme" "adw-gtk3-git" "appimagelauncher" "cava" "cbonsai" "docker-buildx-git" "dracula-cursors-git" "evans" "figma-linux-bin" "google-chrome" "heroic-games-launcher-bin" "hstr" "insomnia-bin" "jetbrains-toolbox" "k6" "kora-icon-theme" "libratbag-git" "lssecret-git" "minecraft-launcher" "mycli" "piper-git" "python-cssutils" "python-material-color-utilities" "python-sqlglot" "qtilitools-git" "sddm-catppuccin-git" "sddm-conf-git" "sddm-sugar-dark" "spotify" "sublime-text-4" "teamviewer" "tidal-hifi-bin" "trizen" "ttf-font-awesome-4" "ttf-icomoon-feather" "ttf-ms-fonts" "ttf-twemoji" "tty-clock" "update-grub" "visual-studio-code-bin" "wdisplays" "wlogout" "yay-git" "yay-git-debug" "zsh-autopair-git");
